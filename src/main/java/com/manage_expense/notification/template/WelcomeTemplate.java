...
public class WelcomeTemplate {
    ...
    private static final String TEMPLATE = """
            <!DOCTYPE html>
                        ...
                        <head>
                          <meta charset="UTF-8" />
                          <title>Welcome to Expense Management</title>
                        </head>
                                ...
                                <table width="600" cellpadding="0" cellspacing="0"
                                  ...
                                  <tr>
                                    <td style="background:#2563eb; padding:20px; color:#ffffff; text-align:center;">
                                      <h1 style="margin:0; font-size:22px;">Welcome to Expense Management 🎉</h1>
                                    </td>
                                  </tr>
                                  <!-- Content -->
                                  <tr>
                                    <td style="padding:30px; color:#333;">
                                      ...
                                      <p style="font-size:14px; line-height:1.6;">
                                        Welcome to <strong>Expense Management</strong>!
                                      ...
                                      <ul style="font-size:14px; color:#555; line-height:1.8; padding-left:20px;">
                                        ...
                                        <li>Manage budgets efficiently</li>
